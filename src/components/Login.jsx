...
const Login = props => {
    ...
    return (
        <div className={style('bg-indigo-900').fullScreen().centerContent()}>
            <div className={style('md:w-1/2 md:gap-6 sm:gap-0 mx-2 grid md:grid-cols-2 sm:grid-cols-1').card()}>
                <div className={style('bg-slate-400 p-6')}>
                    <div className={style('font-extrabold text-center text-2xl text-blue-900')}>Super Admin</div>
                    ...
                    <Form onSubmit={onSubmit}>
                        <div className={style('flex flex-col gap-4')}>
                            ...
                            <div className={style('flex justify-end')}>
                                <Button disabled={busy} color='indigo' type='submit'>Sign in</Button>
                            </div>
                        </div>
                    </Form>
